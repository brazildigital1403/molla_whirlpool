...
Hoje 2 senhas compartilhadas (`whirlpool2026`, `molla@2026@`). Quando alguém sai,
...
Hoje os 3 são dados hardcoded em arquivos `.js`. Se Whirlpool pedir mudança,
