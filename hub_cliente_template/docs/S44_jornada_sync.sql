...
VALUES (
  ...
  '2026-06-18',
  NULL,
  'Início da 3ª campanha LinkedIn (exclusiva da Onda 2 · R$ 10K bruto). Document Ad com conteúdo aprofundado sobre proteção e MetLife Foundation. Captura público qualificado para o retargeting da Onda 3.',
  '/plano-midia#linkedin'
);
